<form action="#" method="post" id="certificate_of_cohabitationForm">
    ...
    <input type="date" class="form-control"  onchange="validatebday(this);updateText();" name="birthdate" required><br>
    ...
    <label for="">Middle Name:</label>
    <input type="text" class="form-control" name="middle_name_female" maxlength="50"  oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '').replace(/^([^.]*)\.(.*)\./, '$1.$2');updateText();" placeholder="Ex. Garcia" ><br>
    ...
    <label for="cohabitant1Birthdate">Birthdate:</label>
    <input type="date" class="form-control" onchange="validatebday(this);updateText();" name="birthdate_female" required><br><hr>
    ...
    <input type="date" id="date" class="form-control" onchange="validateformarriagedate(this);updateText();" name="date_of_marriage" required><br>
    <hr>

<form action="#" method="POST" class="form" id="cecertificate_of_employability_form">
    ...
    <select class="text-left form-control" name="suffix" id="cesuffix" onchange="this.value = this.value.toUpperCase();updateText()">
    ...
    <input type="text" name="purpose" class="form-control" id="cepurpose" oninput="this.value = this.value.toUpperCase();updateText()"

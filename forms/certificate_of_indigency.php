<form action="#" method="post" class="form" id="certificate_of_indigency_form">
...
<script>
    ...
    document.getElementById("indigency2PrintBtn").addEventListener("click", function () {
        let form = document.getElementById("certificate_of_indigency_form");  // Use the unique form ID

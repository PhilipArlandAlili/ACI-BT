...
$officials = [];
$stmt = $conn->prepare("SELECT id, name, position, age, birthdate, address, phone, email, img, img_type FROM officials_sk");
            ...
            <div class="container d-flex flex-column align-items-center justify-content-center">
                <div class="card overflow-hidden">
                    <div class="card-body p-0">
                        <img src="../assets/img/brgy_sk.png" alt="Barangay SK Officials" class="img-fluid">
